...
const productCategoryRoutes = require("./api/v1/routes/productCategory.routes");
...
app.use(cors({
  origin: ["http://localhost:3000", "http://127.0.0.1:3000", "https://locart-backend.vercel.app"],
  credentials: true,
}));
